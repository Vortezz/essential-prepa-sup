...
#let project(title: "", authors: (), date: none, body) = {
  set document(author: authors.map(a => a.name), title: "Essentiel des méthodes de maths")
  ...
  align(center + horizon)[
    #block(text(weight: 800, 30pt, "🧮 Essentiel de maths"))
    #block(text(weight: 600, 20pt, "Méthodes"))
    #v(1em, weak: true)
    #date
  ]
  ...
  align(center,image("maths/logo.jpg", width: 65%))
...
#show: project.with(
  title: "Essentiel des méthodes de maths",
  authors: (
...
#align([_Bienvenue dans l'essentiel de maths de mes cours de prépa. Ce document a pour objectif de contenir l'intégralité des cours des méthodes afin de les réunir à un seul et même endroit. Pourquoi seulement les méthodes? Mes cours de maths sont déjà entièrement rédigés et concis il n'y a donc pas d'utilité à les recopier._
...
#box(height: 1em)
#heading([Chapter title], supplement: [type],)
